...
embedding_UMAP = get_file_with_cache("human_perProtein_ProstT5_inputp3Di.h5_gene_symbol_summarized_UMAP.csv").copy()
proportions = get_file_with_cache("gene_symbol_summarized_proportions.csv").copy()


st.sidebar.write("""### ProstT5 p3Di protein embedding probe tool by Leon French
ProstT5 embeddings for the human genes were generated by Michael Heinzinger. Full details on ProstT5 is available at [bioRxiv](https://www.biorxiv.org/content/10.1101/2023.07.23.550085v1) and [Github](https://github.com/mheinzinger/ProstT5) repository. The default gene list is from the [Lindbohm et al.](https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.12419) study of cognitive decline and risk of dementia.
...
* can the ProstT5 p3Di embeddings, without finetuning discriminate the input genes from the rest of the proteome?
