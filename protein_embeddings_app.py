...
The 10k network of 287,509 bins (10kbp_raw/max/hic_gene_gw_none_by_allbins_max_layer_test.h5ad) was collapsed to 1012 dimensions using PCA, and UMAP for 2D. It primarily represents genomic proximity (but I should setup a comparison test for that).
