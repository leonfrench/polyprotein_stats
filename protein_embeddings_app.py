...
def get_split_embeddings():
    dfA = get_file_with_cache("hic_gene_gw_none_by_allbins_max_10kbp.gene_symbols.csv.gz")
    return dfA
...
The chromatin interaction network for the human genes was generated by Ruchi Lohia, Nathan Fox, and Jesse Gillis. Details about their network is available in the [paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-022-02790-z). 

The 10k network of 287,509 bins (10kbp_raw/max/hic_gene_gw_none_by_allbins_max_layer_test.h5ad) was collapsed to 1012 dimensions using PCA, and UMAP for 2D. It primarily represents genomic proximity and the genomic locations AUROC score provides directly.
