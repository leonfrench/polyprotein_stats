...
Embeddings were averaged across all data from all cell types and guided by the [embedding notebook](https://github.com/CellProfiling/subcell-analysis/blob/main/HPA_U2OS_embedding_subclustering_and_ORA.ipynb) by Konstantin Kahnert.
