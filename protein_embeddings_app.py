...
st.sidebar.write("""### scELMo gene embedding probe tool by Leon French
scELMo (GPT-3.5, not NCBI description based) based embeddings for the human genes were generated by Tianyu Liu and colleagues. Full details on scELMo is available at [scELMo library](https://sites.google.com/yale.edu/scelmolib) and [Github](https://github.com/HelloWorldLTY/scELMo) repository. The default gene list is from the [Lindbohm et al.](https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.12419) study of cognitive decline and risk of dementia.
