...
st.sidebar.write("""### Orthrus gene embedding probe tool by Leon French
Orthrus based gene embedding for the human genes were generated by Philip Fradkin and colleagues. Full details on Orthrus is available at the [project page](https://philechka.com/science/orthrus). The default gene list is from the [Lindbohm et al.](https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.12419) study of cognitive decline and risk of dementia.
